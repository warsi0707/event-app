...
import { updateEvent } from "../redux/slice/eventSlice"
...
export default function UpdateEvent(){
    ...
    const handleUpdateEvent =()=>{
        dispatch(updateEvent({title, description, date, location, id}))
    }
    return (        
         <div className="min-h-screen w-full p-3 lg:w-[900px]  mx-auto flex justify-center md:px-40  items-center">
            <div className="bg-slate-100 shadow-2xl border border-gray-200 -mt-32 w-full p-4 rounded-md">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <button onClick={handleUpdateEvent} className="bg-blue-500 p-1.5 rounded-md text-white cursor-pointer">Post</button>
                </div>
            </div>
        </div>
    )
